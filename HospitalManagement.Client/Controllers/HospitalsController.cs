...
namespace HospitalManagement.Client.Controllers
{
    public class HospitalsController : Controller
    {
        ...
        public HospitalsController(DatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Hospitals != null ? 
                          ...
                          Problem("Entity set 'DatabaseContext.Hospitals'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DatabaseContext.Hospitals'  is null.");
            }
            var hospital = await _context.Hospitals.FindAsync(id);
            if (hospital != null)
            {
